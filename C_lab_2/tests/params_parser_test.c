...
{
  return ((flag1.counter == flag2.counter) && (flag1.is_on == flag2.is_on) && (flag1.argument == flag2.argument));
}
...
bool areParamsEqual(Params *params1, Params *params2)
{
  ...
  return ((are_file_names_equal) && (areFlagsEquals(params1->A, params2->A)) &&
          (areFlagsEquals(params1->b, params2->b)) && (areFlagsEquals(params1->c, params2->c)) &&
          (areFlagsEquals(params1->i, params2->i)) && (areFlagsEquals(params1->n, params2->n)) &&
          (areFlagsEquals(params1->v, params2->v)) && (areFlagsEquals(params1->x, params2->x)) &&
          (areFlagsEquals(params1->E, params2->E)) && (STRINGS_ARE_EQUAL(params1->sub_str, params2->sub_str)));
}
